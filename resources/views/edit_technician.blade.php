            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="m-t-40">
                        ...
                        <form action="{{url('admin/technicians/update',$tech->id)}}" method="POST" enctype="multipart/form-data">
                            {{csrf_field()}}
                        	...
                        	<div class="row">
                        		...
                        		<div class="col-sm-6">
		                        	<div class="form-group">
		                        		<label>Email</label>
		                        		<input type="email" name="email" value="{{$tech->email}}" class="form-control" required>
		                        	</div>
                        		</div>
                        		...
                        		<div class="col-sm-12">
		                        	<div class="form-group">
		                        		...
		                        		<input type="checkbox" name="status" {{$tech->customer->status ? 'checked' : ''}}>
		                        	</div>
                        		</div>
